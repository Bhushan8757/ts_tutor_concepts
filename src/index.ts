...
you can add this in to package.json
*/

/*
Union type
let salary: number | string | number[]
multiple datatype assign with pipe symbol 
*/
...
function contact (details: ContactDetails) {
  console.log(`${details.name}` email address ${details.email} and phone number ${details.phone})
}
*/
...
/*
Definite Assignments Assertion
let dice!: number;
function rollDisc () {
...
rollDice();
console.log(`Current Dice Value is`, dice); // This will not complaint any error
